...
type Props = {
  ...
  setSelectedFeeType: (values: any) => void;
...
const ChargeDropDownField = forwardRef<any, Props>((props, ref) => {
  ...
  const handleFeeTypeChange = (selectedValues) => {

      const selectedFeeType = selectedValues[0]?.feeType || '';
      setSelectedFeeType(selectedValues);
      setValue('feeType', selectedFeeType);
